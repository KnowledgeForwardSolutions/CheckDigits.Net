# S0054: Iso7064Mod37_2 Check Digit Data Annotation

## Story
**As a** .NET developer  
**I want** a reusable C# data annotation that validates values using the Iso7064Mod37_2 check digit algorithm via **CheckDigits.Net**  
...
- Validation succeeds when the value is valid per the Iso7064Mod37_2 algorithm.
- Validation fails when the value does not pass the Iso7064Mod37_2 check.
- Validation succeeds when the value is `null` or empty and the field is not marked as required.
- A default error message is provided (e.g., *“The field {0} has invalid Iso7064Mod37_2 check digit*).
...
- New annotation named Iso7064Mod37_2CheckDigit
...
- Generating or calculating Iso7064Mod37_2 check digits (validation only).
- Support for non-Iso7064Mod37_2 check digit algorithms.
