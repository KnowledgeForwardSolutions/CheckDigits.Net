...
public static class Algorithms
{
   ...
   private static readonly Lazy<ICheckDigitAlgorithm> _figi =
     new(() => new FigiAlgorithm());
...
#pragma warning restore CS0618 // Type or member is obsolete
   ...
   /// <summary>
   ///   Financial Instrument Global Identifier algorithm.
   /// </summary>
   public static ICheckDigitAlgorithm Figi => _figi.Value;
   ...
   /// <summary>
   ///   International Civil Aviation Organization 9303 algorithm for Machine
   ///   Readable Travel Documents Size TD3 (Machine Readable Passports).
   /// </summary>
   public static ICheckDigitAlgorithm Icao9303SizeTD3 => _icao9303SizeTD3.Value;
