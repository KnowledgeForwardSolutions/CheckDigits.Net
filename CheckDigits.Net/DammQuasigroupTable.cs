...
/// </summary>
public class DammQuasigroupTable : ITwoDimensionalLookupTable
{
   private static readonly Int32[,] _quasigroupTable = new Int32[10, 10]
   {
      { 0, 3, 1, 7, 5, 9, 8, 6, 4, 2 },
      { 7, 0, 9, 2, 1, 5, 4, 8, 6, 3 },
      { 4, 2, 0, 6, 8, 7, 1, 3, 5, 9 },
   ...
   /// <inheritdoc/>
   public Int32 this[Int32 x, Int32 y] => _quasigroupTable[x, y];
}
