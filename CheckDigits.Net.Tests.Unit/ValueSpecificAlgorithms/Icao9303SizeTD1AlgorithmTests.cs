...
public class Icao9303SizeTD1AlgorithmTests
{
   ...
   public static TheoryData<LineSeparator, String, String> FieldCharacterMapData => new()
   {
      { LineSeparator.None, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.None, "I<UTO0010000001<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.None, "I<UTO0020000002<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.None, "I<UTO0030000003<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.None, "I<UTO0040000004<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<2" },
      { LineSeparator.None, "I<UTO0050000005<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.None, "I<UTO0060000006<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.None, "I<UTO0070000007<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.None, "I<UTO0080000008<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.None, "I<UTO0090000009<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<2" },
      { LineSeparator.Crlf, "I<UTO00A0000000<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.Crlf, "I<UTO00B0000001<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.Crlf, "I<UTO00C0000002<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.Crlf, "I<UTO00D0000003<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.Crlf, "I<UTO00E0000004<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<2" },
      { LineSeparator.Crlf, "I<UTO00F0000005<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.Crlf, "I<UTO00G0000006<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.Crlf, "I<UTO00H0000007<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.Crlf, "I<UTO00I0000008<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.Crlf, "I<UTO00J0000009<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<2" },
      { LineSeparator.Lf,   "I<UTO00K0000000<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.Lf,   "I<UTO00L0000001<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.Lf,   "I<UTO00M0000002<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.Lf,   "I<UTO00N0000003<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.Lf,   "I<UTO00O0000004<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<2" },
      { LineSeparator.Lf,   "I<UTO00P0000005<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.Lf,   "I<UTO00Q0000006<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.Lf,   "I<UTO00R0000007<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.Lf,   "I<UTO00S0000008<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.Lf,   "I<UTO00T0000009<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<2" },
      { LineSeparator.None, "I<UTO00U0000000<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.None, "I<UTO00V0000001<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.None, "I<UTO00W0000002<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.None, "I<UTO00X0000003<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.None, "I<UTO00Y0000004<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<2" },
      { LineSeparator.None, "I<UTO00Z0000005<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.None, "I<UTO00<0000000<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<0" },
   };
   ...
   public static TheoryData<LineSeparator, String, String> WeightByCharacterPositionData => new()
   {
      // Document number field
      { LineSeparator.None, "I<UTO1000000007<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.None, "I<UTO0100000003<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.None, "I<UTO0010000001<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.None, "I<UTO0001000007<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.None, "I<UTO0000100003<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.None, "I<UTO0000010001<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },
      { LineSeparator.None, "I<UTO0000001007<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<6" },
      { LineSeparator.None, "I<UTO0000000103<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.None, "I<UTO0000000011<<<<<<<<<<<<<<<", "0000000F0000000UTO<<<<<<<<<<<8" },

      // Date of birth field
      { LineSeparator.Crlf, "I<UTO0000000000<<<<<<<<<<<<<<<", "1000007F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.Crlf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0100003F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.Crlf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0010001F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.Crlf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0001007F0000000UTO<<<<<<<<<<<4" },
      { LineSeparator.Crlf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000103F0000000UTO<<<<<<<<<<<0" },
      { LineSeparator.Crlf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000011F0000000UTO<<<<<<<<<<<0" },

      // Date of expiry field
      { LineSeparator.Lf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F1000007UTO<<<<<<<<<<<8" },
      { LineSeparator.Lf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F0100003UTO<<<<<<<<<<<0" },
      { LineSeparator.Lf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F0010001UTO<<<<<<<<<<<4" },
      { LineSeparator.Lf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F0001007UTO<<<<<<<<<<<8" },
      { LineSeparator.Lf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F0000103UTO<<<<<<<<<<<0" },
      { LineSeparator.Lf, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F0000011UTO<<<<<<<<<<<4" },
   };
   ...
   [Theory]
   [InlineData(LineSeparator.None)]
   [InlineData(LineSeparator.Crlf)]
   [InlineData(LineSeparator.Lf)]
      ...
      LineSeparator lineSeparator)
   {
      ...
      var value = GetTestValue(lineSeparator);

      // Act/assert.
      sut.Validate(value).Should().BeTrue();
   }

   public static TheoryData<LineSeparator, String, String> UndetectableErrorData = new()
   {
      { LineSeparator.None, "I<UTOD2314589A7<<<<<<<<<<<<<<<", "7408122F1204159UTO<<<<<<<<<<<6" },  // D231458907 with single char transcription error (0 -> A) with delta 10
      { LineSeparator.Crlf, "I<UTON2314589A7<<<<<<<<<<<<<<<", "7408122F1204159UTO<<<<<<<<<<<6" },  // D231458907 with single char transcription error (D -> N) with delta 10
      { LineSeparator.None, "I<UTOL89890C236<<<<<<<<<<<<<<<", "7408122F1204159UTO<<<<<<<<<<<8" },  // L898902C36 with two char transposition error (2C -> C2) with delta 10
      { LineSeparator.Lf,   "I<UTO0000000000<<<<<<<<<<<<<<<", "8812728F0000000UTO<<<<<<<<<<<0" },  // 8812278 with two char transposition error (27 -> 72) with delta 5
      { LineSeparator.None, "I<UTO0000000000<<<<<<<<<<<<<<<", "0000000F8812728UTO<<<<<<<<<<<2" },  // 8812278 with two char transposition error (27 -> 72) with delta 5
   };

   [Theory]
   [MemberData(nameof(UndetectableErrorData))]
