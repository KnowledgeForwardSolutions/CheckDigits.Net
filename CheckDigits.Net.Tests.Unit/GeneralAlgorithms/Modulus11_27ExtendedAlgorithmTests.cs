...
public class Modulus11_27ExtendedAlgorithmTests
{
   private readonly Modulus11_27ExtendedAlgorithm _sut = new();
   ...
   [Fact]
   public void Modulus11_27ExtendedAlgorithm_AlgorithmDescription_ShouldReturnExpectedValue()
      => _sut.AlgorithmDescription.Should().Be(Resources.Modulus11_27ExtendedAlgorithmDescription);
   ...
   [Fact]
   public void Modulus11_27ExtendedAlgorithm_AlgorithmName_ShouldReturnExpectedValue()
      => _sut.AlgorithmName.Should().Be(Resources.Modulus11_27ExtendedAlgorithmName);
   ...
   [Fact]
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldReturnFalse_WhenInputIsNull()
   {
      // Act/assert.
   ...
   [Fact]
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldReturnFalse_WhenInputIsEmpty()
   {
      // Act/assert.
   ...
   [InlineData("6", 'X')]        // Sum = 12, mod = (11-(12%11))%11=10
   ...
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldReturnAllPossibleValidCheckDigits(
      String value,
   ...
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldCorrectlyWeightCharactersByPosition(
      String value,
      Char expectedCheckDigit)
   {
      // Act/assert.
   ...
   [InlineData("000040", 'X')]
   [InlineData("0068", 'X')]
   [InlineData("110111111", 'X')]
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldCalculateExpectedCheckDigit(
      String value,
      Char expectedCheckDigit)
   {
      // Act/assert.
   ...
   [Fact]
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldCalculateExpectedCheckDigit_WhenInputIsAllZeros()
   {
      // Arrange.
      var value = "00000";
   ...
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldReturnFalse_WhenInputContainsNonDigitCharacter(String value)
   {
   ...
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldReturnTrue_WhenModulus11HasRemainderOf10(String value)
   {
      _sut.TryCalculateCheckDigit(value, out var checkDigit).Should().BeTrue();
   ...
   public void Modulus11_27ExtendedAlgorithm_TryCalculateCheckDigit_ShouldReturnTrue_ForBenchmarkValues(String value)
   ...
   [Fact]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnFalse_WhenInputIsNull()
      => _sut.Validate(null!).Should().BeFalse();

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnFalse_WhenInputIsEmpty()
      => _sut.Validate(String.Empty).Should().BeFalse();

   [Theory]
   [InlineData("0")]       // Zero would return true unless length is explicitly checked.
   [InlineData("1")]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnFalse_WhenInputHasLengthLessThanTwo(String value)
   ...
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldCorrectlyWeightCharactersByPosition(String value)
   ...
   [InlineData("40X")]           // 4 with weight 3 = 12, 12 % 11 = 1, 11 - 1 = 10
   [InlineData("0068X")]
   [InlineData("110111111X")]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnTrue_WhenValueContainsValidCheckDigit(String value)
      => _sut.Validate(value).Should().BeTrue();
   ...
   [InlineData("0086X")]         // 0068X  with two digit transposition error 68 -> 86
   [InlineData("56126865")]      // 56621865 with jump transposition 621 -> 126
   [InlineData("101733325")]     // 101722325 with twin error 22 -> 33
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnFalse_WhenInputContainsDetectableError(String value)
      => _sut.Validate(value).Should().BeFalse();

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnTrue_WhenInputIsAllZeros()
   ...
   [InlineData("0068X")]
   [InlineData("110111111X")]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnTrue_WhenCheckDigitIsCalculatesAsX(String value)
      => _sut.Validate(value).Should().BeTrue();

   [Theory]
   [InlineData("0000G00005")]    // 'G' - '0' = 18
   [InlineData("0000+00005")]    // '+' - '0' = -10
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnFalse_WhenInputContainsNonDigitCharacter(String value)
      => _sut.Validate(value).Should().BeFalse();

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnFalse_WhenCheckDigitIsNonDigitCharacter()
      => _sut.Validate("000010000?").Should().BeFalse();    // Actual check digit would be 5

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnFalse_WhenCheckDigitIsLowerCaseXInsteadOfUpperCase()
      => _sut.Validate("110111111x").Should().BeFalse();    // SBN-10 Roman London, Peter Marsden
   ...
   public void Modulus11_27ExtendedAlgorithm_Validate_ShouldReturnTrue_ForBenchmarkValues(String value)
      => _sut.Validate(value).Should().BeTrue();
   ...
   [Fact]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnFalse_WhenInputIsEmpty()
      => _sut.Validate(String.Empty, _acceptAllMask).Should().BeFalse();

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnFalse_WhenAllNonCheckDigitCharactersAreMaskedOut()
      => _sut.Validate("000 000 000 0", _rejectAllMask).Should().BeFalse();

   [Theory]
   [InlineData("0")]       // Zero would return true unless length is explicitly checked.
   [InlineData("1")]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnFalse_WhenInsufficientUnmaskedCharactersToCalculateCheckDigit(String value)
   ...
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldCorrectlyWeightCharactersByPosition(String value)
   ...
   [InlineData("40X")]             // 4 with weight 3 = 12, 12 % 11 = 1, 11 - 1 = 10
   [InlineData("006 8X")]
   [InlineData("110 111 111 X")]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnTrue_WhenValueContainsValidCheckDigit(String value)
      => _sut.Validate(value, _groupsOfThreeMask).Should().BeTrue();
   ...
   [InlineData("0068X")]
   [InlineData("110111111X")]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnTrue_WhenValueContainsValidCheckDigitAndMaskAcceptsAllCharacters(String value)
   ...
   [InlineData("008 6X")]          // 0068X  with two digit transposition error 68 -> 86
   [InlineData("561 268 65")]      // 56621865 with jump transposition 621 -> 126
   [InlineData("101 733 325")]     // 101722325 with twin error 22 -> 33
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnFalse_WhenInputContainsDetectableError(String value)
      => _sut.Validate(value, _groupsOfThreeMask).Should().BeFalse();

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnTrue_WhenInputIsAllZeros()
   ...
   [InlineData("006 8X")]
   [InlineData("110 111 111 X")]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnTrue_WhenCheckDigitIsCalculatesAsX(String value)
      => _sut.Validate(value, _groupsOfThreeMask).Should().BeTrue();

   [Theory]
   [InlineData("000 0G0 000 5")]    // 'G' - '0' = 18
   [InlineData("000 0+0 000 5")]    // '+' - '0' = -10
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnFalse_WhenInputContainsNonDigitCharacter(String value)
      => _sut.Validate(value, _groupsOfThreeMask).Should().BeFalse();

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnFalse_WhenCheckDigitIsNonDigitCharacter()
      => _sut.Validate("000 010 000 ?", _groupsOfThreeMask).Should().BeFalse();    // Actual check digit would be 5

   [Fact]
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnFalse_WhenCheckDigitIsLowerCaseXInsteadOfUpperCase()
      => _sut.Validate("110 111 111 x", _groupsOfThreeMask).Should().BeFalse();    // SBN-10 Roman London, Peter Marsden
   ...
   public void Modulus11_27ExtendedAlgorithm_ValidateMasked_ShouldReturnTrue_ForBenchmarkValues(String value)
      => _sut.Validate(value, _groupsOfThreeMask).Should().BeTrue();
