...
Valid characters for calculating a Modulus11 check digit are decimal digits ('0' - '9').

The check digit generated by the Modulus11 algorithm is a decimal digit ('0' - '9') 
or an uppercase 'X'.
