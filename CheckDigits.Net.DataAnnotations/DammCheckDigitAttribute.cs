...
///   Damm check digit sequence for validation to succeed. Successful 
///   validation means that the value does not contain any transcription errors 
///   capable of being detected by the Damm algorithm.
/// </summary>
/// <remarks>
///   <para>
///      Use this attribute to enforce that a value conforms to the Damm 
///      algorithm. The validation passes if the value is null or an empty 
///      string or if the value contains a valid Damm check digit in the 
...
///            minimum required for a valid Damm check digit sequence.
///         </item>
///         <item>
///            The value contains non-numeric characters, as the default Damm
///            quasigroup implementation only processes numeric digits.
///         </item>
///         <item>
///            The value does not contain a valid Damm check digit in the 
///            right-most character position.
///         </item>
///      </list> 
///   </para>
