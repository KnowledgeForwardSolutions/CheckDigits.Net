...
public class ValueSpecificAlgorithmBenchmarks
{
   ...
   {
      yield return [ Algorithms.Icao9303, Algorithms.Icao9303.AlgorithmName, "U7Y" ];
      yield return [ Algorithms.Icao9303, Algorithms.Icao9303.AlgorithmName, "U7Y8SX" ];
      yield return [ Algorithms.Icao9303, Algorithms.Icao9303.AlgorithmName, "U7Y8SXRC0" ];
      yield return [ Algorithms.Icao9303, Algorithms.Icao9303.AlgorithmName, "U7Y8SXRC0O3S" ];
      yield return [ Algorithms.Icao9303, Algorithms.Icao9303.AlgorithmName, "U7Y8SXRC0O3SC4I" ];
   ...
   {
      yield return [ Algorithms.Iban, Algorithms.Iban.AlgorithmName, "BE00096123456769" ];
      yield return [ Algorithms.Iban, Algorithms.Iban.AlgorithmName, "GB00WEST12345698765432" ];
      yield return [ Algorithms.Iban, Algorithms.Iban.AlgorithmName, "SC00MCBL01031234567890123456USD" ];
   }
   ...
   {
      yield return [ Algorithms.Isan, Algorithms.Isan.AlgorithmName, "ISAN D02C-42E9-5418-3EE2-Q" ];
      yield return [ Algorithms.Isan, Algorithms.Isan.AlgorithmName, "ISAN C594-660A-8B2E-5D22-X" ];
      yield return [ Algorithms.Isan, Algorithms.Isan.AlgorithmName, "ISAN E953-0C32-BC0E-E83B-2" ];
      yield return [ Algorithms.Isan, Algorithms.Isan.AlgorithmName, "ISAN D02C-42E9-5418-3EE2-Q-1291-C8AE-O" ];
      yield return [ Algorithms.Isan, Algorithms.Isan.AlgorithmName, "ISAN C594-660A-8B2E-5D22-X-6DDA-3272-E" ];
      yield return [ Algorithms.Isan, Algorithms.Isan.AlgorithmName, "ISAN E953-0C32-BC0E-E83B-2-6986-7B20-F" ];
   }
