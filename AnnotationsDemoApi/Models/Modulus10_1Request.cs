...
{
   [Required, Modulus10_1CheckDigit(ErrorMessage = "CAS Registry Number check digit error")]
   public String CasNumber { get; set; } = null!;
}

public class Modulus10_1RequestGlobalizedErrorMessage
{
   [Required, Modulus10_1CheckDigit(ErrorMessageResourceName = "InvalidCasNumber", ErrorMessageResourceType = typeof(Resources.SharedStrings))]
   public String CasNumber { get; set; } = null!;
}
